...
// 获取商品列表
app.get('/page3-data', authenticateToken, async (req, res) => {
    try {
...
// 添加商品
app.post('/page3-data', authenticateToken, async (req, res) => {
...
// 更新商品
app.put('/page3-data/:id', authenticateToken, async (req, res) => {
    const { id } = req.params;
    const productData = req.body;
    try {
        await pool.query(
...
// 删除商品
app.delete('/page3-data/:id', authenticateToken, async (req, res) => {
    const { id } = req.params;
    try {
